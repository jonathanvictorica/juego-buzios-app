...
import com.jmg.buzios.controller.edificio.VerMuralla;
 ...
 * @author Alumno
 */
public class VVerMuralla extends javax.swing.JFrame {

    private VerMuralla vermuralla;
    /**
    ...
    public VVerMuralla(VerMuralla vermuralla) {
        this.vermuralla = vermuralla;
        initComponents();
    ...
    private void cmdDestruiredificioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDestruiredificioActionPerformed
        try {
            this.vermuralla.destruiredificio();
    ...
    private void cmdElevarniveledificioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdElevarniveledificioActionPerformed
        try {
            this.vermuralla.elevarniveledificio();
        } catch (SQLException ex) {

        }
    }//GEN-LAST:event_cmdElevarniveledificioActionPerformed

    public VerMuralla getVermuralla() {
        return vermuralla;
    }
    ...
    public PanelImage getEdificioAcademia() {
        return edificioAcademia;
    }
    ...
    public PanelImage getPanelImage4() {
        return panelImage4;
    }

    public PanelImage getPanelImage5() {
        return panelImage5;
    }

    public PanelImage getPanelVentanaedificio() {
        return panelVentanaedificio;
    }

    public PanelImage getPanelimagenedificio() {
        return panelimagenedificio;
    }
