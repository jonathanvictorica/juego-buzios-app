...
import com.jmg.buzios.controller.edificio.VerPalaciooResidencia;
 ...
 * @author Alumno
 */
public class VVerPalaciooResidencia extends javax.swing.JFrame {

    private VerPalaciooResidencia verpalaciooresidencia;
    ...
    public VVerPalaciooResidencia(VerPalaciooResidencia palacio) {
        this.verpalaciooresidencia = palacio;
        initComponents();
    ...
    private void cmdDestruiredificioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDestruiredificioActionPerformed
        try {
            this.verpalaciooresidencia.destruiredificio();
    ...
    private void cmdElevarniveledificioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdElevarniveledificioActionPerformed
        try {
            this.verpalaciooresidencia.elevarniveledificio();
        } catch (SQLException ex) {
